    ...
    <div className="mainsection text-white font-Ciz overflow-y-scroll h-[80vh] scrollbar-thumb-[#9b6b35] scrollbar-track-[#1a1a1a]">
      <div className="maindetails px-6 py-4">
        {oncompletion ? (
          ...
          <div className="conversation space-y-4 flex flex-col h-[50vh] justify-start">
            {responses.length === 0 ? (
              <p className="text-[#bfa887]">No inputs yet. Try sending one!</p>
            ) : (
              responses.map((item, index) => (
                <div 
                  key={index} className="border border-[#9b6b35]/60 rounded-xl p-4 bg-black/30">
